...
if __name__ == '__main__':
    with tf.Session() as sess:
        ...
        model.load_model()
        new_image = model.predict('./data/LR/1.jpg')
        cv2.imwrite('./output/1.jpg', new_image)
        new_image = model.predict('./data/LR/2.jpg')
        cv2.imwrite('./output/2.jpg', new_image)
        new_image = model.predict('./data/LR/3.jpg')
        cv2.imwrite('./output/3.jpg', new_image)
        new_image = model.predict('./data/LR/4.jpg')
        cv2.imwrite('./output/4.jpg', new_image)
        new_image = model.predict('./data/LR/5.jpg')
        cv2.imwrite('./output/5.jpg', new_image)
        new_image = model.predict('./data/LR/6.jpg')
        cv2.imwrite('./output/6.jpg', new_image)
        new_image = model.predict('./data/LR/7.jpg')
        cv2.imwrite('./output/7.jpg', new_image)
        new_image = model.predict('./data/LR/8.jpg')
        cv2.imwrite('./output/8.jpg', new_image)
        new_image = model.predict('./data/LR/9.jpg')
        cv2.imwrite('./output/9.jpg', new_image)
        new_image = model.predict('./data/LR/10.jpg')
        cv2.imwrite('./output/10.jpg', new_image)
