---
title: "Project 3 - Main Script - GBM"
...
```{r train_label}
train_label_path <- "/Users/hongru/Documents/GitHub/Fall2018-Proj3-Sec1-grp7/Github/data/train_set/label.csv"
...
test_HR_dir <- paste(test_dir, "HR_GBM/", sep="")
...
### Calculate and compare PSNR for different models

```{r}
source("../lib/calculate_psnr.R")
hr_true_dir <- "../data/test_set/HR_true/"
hr_gbm_dir <- "../data/test_set/HR_GBM/"
hr_srcnn_dir <- "../data/test_set/HR_CNN/"
psnr_gbm <- calculate_psnr(hr_gbm_dir, hr_true_dir)
psnr_gbm[1]
psnr_srcnn <- calculate_psnr(hr_srcnn_dir, hr_true_dir)
psnr_srcnn[1]
```
